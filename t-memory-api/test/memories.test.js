...
describe("GET model test", () => {
    ...
    it("Deve chamar o schema e retornar a id da timeline correta da memória", () => {
    ...
    it("Deve chamar o schema e retornar se está arquivado correta da memória", () => {
