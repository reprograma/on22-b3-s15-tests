...
describe('Get Model Test', () => {
    ...
    it('Deve chamar schema a retornar a descrisão correta da memória', () => {
    ...
    it('Deve chamar e retornar a url da imagen correta da memória', () => {
    ...
    it('Deve chamar o schema e retornar o valor retornado como verdadeiro', () => {
