...
describe('GET model test', () => {
    ...
    it('Deve chamar o schema e retornar a URL de imagem da memória', () => {
        expect(memory.imgURL).toBe("https://www.imagem.com")
    })
    it('Deve chamar o schema e retornar a timelineID da memória', () => {
    ...
    it('Deve chamar o schema e retornar o valor arquivado da memória', () => {
...
describe('UPDATE route test', () => {
    ...
    it('Deve salvar a atualização da memória no banco de dados', () => {
        memory.save().then((dados) => {
