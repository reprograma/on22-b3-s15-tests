...
describe("GET model test", () => {
    ...
    it("Deve chamar o schema e retronar a url da imagem correta da memória", () => {
        expect(memory.imgURL).toBe("https://www.imagem.com")
    });
    it("Deve chamar o schema e retornar o de timeline correto da memória", () => {
    ...
    it("Deve chamar o shcmea e retornar o valor arquivado como verdadeiro", () => {
